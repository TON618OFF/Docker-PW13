...
export const translations: Translations = {
  ru: {
    ...
    'upload.error.loadArtists': 'Ошибка загрузки списка артистов',
    'upload.description': 'Загрузите новый трек на платформу',
  ...
  en: {
    ...
    'upload.error.loadArtists': 'Error loading artists list',
    'upload.description': 'Upload a new track to the platform',
