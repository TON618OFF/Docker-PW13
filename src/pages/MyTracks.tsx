...
import { Music, Play, Clock, Search, Heart, Trash2, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pb-24 md:pb-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-2">{t('profile.myTracks')}</h1>
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center bg-card/50 backdrop-blur">
          ...
          <h3 className="text-xl font-semibold mb-2">
            {searchQuery ? t("library.emptySearch") : t("profile.myTracks")}
          </h3>
