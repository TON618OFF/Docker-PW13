...
DROP POLICY IF EXISTS "Anyone can view public albums" ON public.albums;
...
DROP POLICY IF EXISTS "Anyone can view track genres" ON public.track_genres;

DROP POLICY IF EXISTS "Authenticated users can insert track genres" ON public.track_genres;
