-- =================================================================================================
-- ПОЛНЫЙ ЕДИНЫЙ SQL СКРИПТ ДЛЯ БАЗЫ ДАННЫХ IMPERIAL TUNES (SUPABASE)
-- Версия: 6.0 (Полная рабочая версия со всеми исправлениями)
-- Дата: 2025-02-01
-- =================================================================================================
-- Этот скрипт создаёт полную схему базы данных со всеми последними изменениями:
-- - Управление ролями администраторами и дистрибьюторами
-- - Ограничение доступа артистов только к текущему активному профилю
-- - Автоматический сброс анкет при изменении роли
-- - Все функции, триггеры, политики безопасности и storage buckets
-- =================================================================================================
...
-- Функция для проверки изменения роли и сброса анкет при изменении роли артиста
...
BEGIN
  ...
  IF OLD.role_id IS DISTINCT FROM NEW.role_id THEN
    ...
    -- 2. Пользователь - дистрибьютор И роль меняется со "слушатель" на "артист" (одобрение анкет)
